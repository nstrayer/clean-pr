...
2. [P1] Severity model is inconsistent across core docs
   - References:
     - `agents/pattern-scanner.md:67`
     - `commands/check.md:92`
     - `skills/pr-cleanliness/SKILL.md:56`
...
3. [P2] Logging guidance conflicts with regex catalog
   - References:
     - `skills/pr-cleanliness/references/anti-patterns.md:13`
     - `agents/pattern-scanner.md:100`
     - `commands/fix.md:107`
...
4. [P2] Base branch fallback logic is inconsistent/incomplete
   - References:
     - `skills/pr-cleanliness/SKILL.md:65`
     - `commands/check.md:24`
     - `commands/fix.md:26`
     - `commands/split.md:24`
...
5. [P2] `split` says "full diff" but collects only file status
   - Reference: `commands/split.md:39`
...
6. [P3] Missing regression harness for pattern quality
   - References:
     - `skills/pr-cleanliness/references/anti-patterns.md:1`
     - `agents/pattern-scanner.md:41`
